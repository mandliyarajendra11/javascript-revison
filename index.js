...
// note in var and let you can change/edit value 
//in var you can redeclare variable

// redeclear     change/edit
// var a=34;     let a=53;
// var a=42;     a=51;
...
// const myColors = ['red', 'green', 'blue', 'white','pink', 'black'];
...
// // //price < 400
// const findElem = prices.find((currVal) =>  currVal < 480 );
...
// const array = [1, 30, 10, 21, 100000, 4];
// console.log(array.sort());// 1 10 1000  consider as a string
// console.log(array.sort((a,b)=>a>b?1:-1))  //1 4 10 21 30 10000
...
//   const newMonth = months.splice(months.length-3,3,"Dec");
//  console.log(months);
...
// mystring = ["rm","noov","hoti","hai"];
// for (const iterator of mystring) {
//   console.log(iterator)
// }
// mystring = "you noon hitu";
...
//  const arrn = [ ['zone_1', 'zone_2'], ['zone_3', ['zone_1', 'zone_2', ['zone_1', 'zone_2']]] ];
...
// console.log(myBioData.indexOf("l",-1));
